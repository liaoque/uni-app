...
class SendMail(object):
    def __init__(self, title=None, content=None,
        ...
        self.username = "844596330@qq.com"  # 用户名（发件人的邮箱账号或用户名）
        self.passwd = "czqqxdvkcudlbbee"  # 16位的SMTP授权码（不含空格）
        self.recv = ['844596330@qq.com'] # 收件人，多个要传list ['a@qq.com','b@qq.com]
...
if __name__ == "__main__":
    ...
    m = SendMail(u"苏宁登录",content=content,file = file,image=image)
    m.send_mail()